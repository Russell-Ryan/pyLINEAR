...
class Logger(object):
    ...
    def write(self,text):
        ...
        if self.logging:
            if match:
                ttype=match.group(0)[1:-1]
                #if ttype in ('info','warn','alarm','debug','title'):
                #    f='['+ttype+' {}] {}'
                #else:
                #    f='[{}] {}'
...
if __name__=='__main__':
    ...
    sys.stderr=Logger('Test',logfile='testerr.log')
    ...
    #print('[warn]',[1,2,34])
    raise ZeroDivisionError("canot do 1/0")
