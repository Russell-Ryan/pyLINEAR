...
setup(name='pylinear',
      ...
      platforms='posix',
      install_requires=['numpy','scipy','astropy','h5axeconfig @ git+https://github.com/russell-ryan/h5axeconfig#egg=h5axeconfig','fitsimage @ git+https://github.com/russell-ryan/fitsimage#egg=fitsimage','emcee','ruamel.yaml','pkginfo','shapely','tqdm','psutil'],
